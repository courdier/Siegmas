...
to initMapWithMasc
   ...
   [
      ...
      ask patches [  
        ; if (pxcor = 34 and pycor = 19) [show pcolor] ; just for debug

        ifelse (isInvalidArea?) 
        [ set deteriorationLevel 0]
        [ ifelse (member? pcolor g_lessDeterioratedlist)
              [ set deteriorationLevel random min list 90 ((position pcolor g_lessDeterioratedlist) * 10) ] ; 0, 10, 20, 30, ...
...
to highlight
  ...
  set g_agentIdToPlot1 turtle #_agent_plot1
  set g_agentIdToPlot2 turtle #_agent_plot2
  set g_agentIdToPlot3 turtle #_agent_plot3
  set g_agentIdToPlot4 turtle #_agent_plot4
  set g_agentIdToPlot5 turtle #_agent_plot5
  set g_agentIdToPlot6 turtle #_agent_plot6
  display
end
...
to plotAgents
      ...
      if (is-turtle? turtle #_agent_plot1) [ 
          set-current-plot "Agent ID1 Deviance Level (%)"
          set-current-plot-pen "deviance"
          ifelse (is-externalHelp? turtle #_agent_plot1) 
              [set-plot-pen-color yellow] 
              [ ifelse (is-manager? turtle #_agent_plot1) [set-plot-pen-color red] [set-plot-pen-color green]]
          ask turtle #_agent_plot1 [plot devianceLevel]
      ]
      if ( is-turtle? turtle #_agent_plot2) [ 
          set-current-plot "Agent ID2 Deviance Level (%)"
          set-current-plot-pen "deviance"
          ifelse (is-externalHelp? turtle #_agent_plot2) 
              [set-plot-pen-color yellow] 
              [ ifelse (is-manager? turtle #_agent_plot2) [set-plot-pen-color red] [set-plot-pen-color green]]
          ask turtle #_agent_plot2 [plot devianceLevel]
      ]
      if ( is-turtle? turtle #_agent_plot3) [ 
          set-current-plot "Agent ID3 Deviance Level (%)"
          set-current-plot-pen "deviance"
          ifelse (is-externalHelp? turtle #_agent_plot3) 
              [set-plot-pen-color yellow] 
              [ ifelse (is-manager? turtle #_agent_plot3) [set-plot-pen-color red] [set-plot-pen-color green]]
          ask turtle #_agent_plot3 [plot devianceLevel]
      ]
      if( is-turtle? turtle #_agent_plot4) [ 
          set-current-plot "Agent ID4 Deviance Level (%)"
          set-current-plot-pen "deviance"
          ifelse (is-externalHelp? turtle #_agent_plot4) 
              [set-plot-pen-color yellow] 
              [ ifelse (is-manager? turtle #_agent_plot4) [set-plot-pen-color red] [set-plot-pen-color green]]
          ask turtle #_agent_plot4 [plot devianceLevel]
      ]
      if ( is-turtle? turtle #_agent_plot5) [ 
          set-current-plot "Agent ID5 Deviance Level (%)"
          set-current-plot-pen "deviance"
          ifelse (is-externalHelp? turtle #_agent_plot5) 
              [set-plot-pen-color yellow] 
              [ ifelse (is-manager? turtle #_agent_plot5) [set-plot-pen-color red] [set-plot-pen-color green]]
          ask turtle #_agent_plot5 [plot devianceLevel]
      ]
      if ( is-turtle? turtle #_agent_plot6) [ 
          set-current-plot "Agent ID6 Deviance Level (%)"
          set-current-plot-pen "deviance"
          ifelse (is-externalHelp? turtle #_agent_plot6) 
              [set-plot-pen-color yellow] 
              [ ifelse (is-manager? turtle #_agent_plot6) [set-plot-pen-color red] [set-plot-pen-color green]]
          ask turtle #_agent_plot6 [plot devianceLevel]
      ]
end
...
to go
  ...
  if (ticks = 1) [output-print word "*** Start of the simulation " date-and-time]
  ...
  [ output-print word "*** End of simulation " date-and-time
    output-print word "Exporting data in " g_csvPlotsExportFile 
    export-all-plots g_csvPlotsExportFile
    stop]
end
